...
public class Skalar extends Fish {
    public Skalar(Context context, ViewGroup vg, int startX, int startY, int age, Gender gender) {
        super(context, vg, startX, startY, age, gender, R.layout.skalar);
    }
    @Override
    public void update_position() {
        ...
        act.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (orientation == 1) {
                    fishImageView.setImageResource(R.drawable.skalarl);
                } else if (orientation == 2) {
                    fishImageView.setImageResource(R.drawable.skalarr);
                }
            }
        });
    }
