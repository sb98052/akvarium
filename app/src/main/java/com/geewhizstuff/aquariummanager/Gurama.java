...
public class Gurama extends Fish {
    public Gurama(Context context, ViewGroup vg, int startX, int startY, int age, Gender gender) {
        super(context, vg, startX, startY, age, gender, R.layout.gurama);
    ...
    public void update_position() {
        ...
        act.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (orientation == 1) {
                    fishImageView.setImageResource(R.drawable.guramal);
                } else if (orientation == 2) {
                    fishImageView.setImageResource(R.drawable.guramar);
                }
            }
        });
    }
